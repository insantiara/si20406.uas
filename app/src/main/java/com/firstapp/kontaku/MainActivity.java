...
import com.firstapp.kontaku.mydata.adapterdataku;
import com.firstapp.kontaku.mydata.dataku;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void bacaData() {
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                adapterMyData = new adapterdataku(MainActivity.this, list);
    ...
    private void setClick() {
        adapterMyData.setOnCallBack(new adapterdataku.OnCallBack() {
            @Override
            public void onTblHapus(dataku myData) {
                hapusData(myData);
            }
        });
    }

    private void hapusData(dataku myData) {
    ...
    private void showDialogTambahData() {
        ...
        dialog.setContentView(R.layout.tambahdata);
    ...
    private void simpanData(String s) {
        ...
        dataku myData = new dataku(kunci, s);
